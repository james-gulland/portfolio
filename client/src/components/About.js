        ...
        <section>
          ...
          <div id="about-container">
            <p className="para black">
              ...
              it). I studied in Business Information Technology, so basically half business, half
              technology. From my degree, I started out programming but quickly moved into
              managerial roles, because I like working with people, and then got into a love affair
            ...
            <p className="para black">
              ...
              roots, I am currently honing my craft as a full-stack software engineer, with a
              passion for creating clean and functional UIs.
            </p>
            <h2>What am I looking for?</h2>
            <p className="para black">
              That is a bit of a deep, existential question, isn&apos;t it?! Oh... you mean
              job-wise? Well, I am looking for a full-stack role with an emphasis on the front-end;
              somewhere I can flex my product and UX chops, whilst satisfying the logical side of my
              brain, by integrating with APIs, databases, and all things data.
            </p>
            <p className="para black">
