      ...
      <main id="main-content">
        ...
        <section>
          <div id="title-container">
            ...
            <p className="para">
              A tongue-in-cheek remake of the classic battleships game, built with JavaScript, HTML5
              and CSS
            </p>
          </div>
          ...
          <div className="portfolio-hero-container">
            ...
            <div className="links-container">
              <ul>
                <Link
                  to="https://james-gulland.github.io/battleships/"
                  target="_blank"
                ...
                <Link
                  to="https://github.com/james-gulland/battleships/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <li className="pill active">
        ...
        <section className="portfolio-copy">
          <p className="para black">
            The first GA Software Engineering immersive course project was in week 4 of the course,
            with the brief of creating a Battleships game using JavaScript, HTML and CSS.
          </p>
          <p className="para black">
            I learnt a lot about streamlined, readable, and reusable code, by implementing objects,
            functions and methods in JavaScript, as well as had some fun with HTML5 and CSS
            techniques.
          </p>
          <p className="para black">
            ...
            <span className="link link-small">
              <Link
                to="https://github.com/james-gulland/battleships/#readme"
                target="_blank"
                rel="noopener noreferrer"
              >
                here
